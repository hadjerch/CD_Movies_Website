 ...
 <div class="site-branding-area">
        <div class="container">
            <div class="row">			
				...
				<h1><a href="index.php"><img src="img/image/log3.png"></a></h1>
				</div>
				<div class="navbar-header">
...
<div class="slider-area">
			...
			<div class="block-slider block-slider4">
				<ul class="" id="bxslider-home4">
					<li>
						<img src="img/image/tb.png" alt="Slide">
					</li>
					<li><img src="img/image/mid.png" alt="Slide">
					</li>
					<li><img src="img/image/for.png" alt="Slide">
					</li>
					<li><img src="img/image/bko.png" alt="Slide">
					</li>
				</ul>
			</div>
			<!-- ./Slider -->
                    ...
                    <div class="product-bit-title text-center">
                        ...
                        <div class="product-carousel">
                            <div class="single-product">
                                ...
                                <center>
                                <h2><a href="shop.php">Star Trek Future Begins</a></h2>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="shop.php" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                </div>
                                <center>
                            ...
                            <div class="single-product">
                                ...
                                <center>
                                <h2><a href="single-product.html">The Call </a></h2>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="img/image/forg.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="shop.php" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
						...
						<div class="product-carousel">
                            ...
                            <div class="single-product">
                                ...
                                <center>
                                <h2><a href="shop.php">The Raid Redemption</a></h2>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="img/image/witch.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single-product.html" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
						...
						<div class="product-carousel">
                            <div class="single-product">
                                ...
                                <center>
                                <h2><a href="shop.php">Parasite</a></h2>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="img/image/Midi.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="shop.php" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                ...
                                <center>
                                <h2><a href="shop.php">Midnight</a></h2>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2><a href="index.php"><img src="img/image/logo4.png"></a></h2>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
				<br/><br/>
                2022 - 2023 © PT Korean-CD Algeria   
                </div>
